workspace {
    ...
    model {
        ...
        clientPortal -> attractions "Wybiera atrakcje" ""
        clientPortal -> reviews "Recenzuje plany podróży" ""
        clientPortal -> planning "Planuje podróż" ""
        clientPortal -> profiles "Zarządza profilem użytkowików" ""
        clientPortal -> booking "Rezerwuje miejsca pobytu" ""
        clientPortal -> complaints "Zgłasza reklamacje" ""

        profiles -> backendDatabase "Zapisuje i odczytuje informacje o profilach"

        planning -> recommendations "Pobiera rekomendacje" "SYNC"
        planning -> booking "Pobiera zarezrwowane pobyty" "SYNC"
        planning -> backendDatabase "Zapisuje i odczytuje plany"

        reviews -> backendDatabase "Zapisuje i odczytuje recenzje"

        booking -> payments "Zleca dokonanie płatności" "SYNC"
        booking -> backendDatabase "Zapisuje i odczytuje rezerwacje"

        attractions -> backendDatabase "Zapisuje i odczytuje atrakcje"
        attractions -> planning "Przypisuje atrakcje do planu podróży" "SYNC"

        complaints -> backendDatabase "Zapisuje i odczytuje informacje o reklamacjach"
