...
import rzepiszczak.damian.tripmaker.trip.readmodel.TravelerTrips;
import rzepiszczak.damian.tripmaker.trip.readmodel.TripsView;
...
class TripsController {
    ...
    ResponseEntity<Void> createTrip(@PathVariable String travelerId, @RequestBody CreateTripRequest createTripRequest) {
        ...
        return ResponseEntity.created(URI.create("/travelers/" + travelerId + "/trips/" + tripId.id())).build();
    }
}
